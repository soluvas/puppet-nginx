...
#   }
#   nginx::bippo_commerce { "www.berbatik5.${::fqdn}":
#     root          => "/home/${developer}/berbatik_dev/commerce/www",
#     domain        => "berbatik5.${::fqdn}",
#     mobile_domain => "m.berbatik5.${::fqdn}",
#     server_name   => ["www.berbatik5.${::fqdn}", "berbatik5.${::fqdn}"],
#     commerce_uri  => 'http://localhost:8181/',
#     tenant_id     => 'berbatik',
#     tenant_env    => 'dev',
#   }
#
define nginx::bippo_commerce52(
  $home,
  $domain,
  $mobile_domain,
  $ensure              = 'present',
  ...
  nginx::site { $name:
    ...
    content => template('nginx/bippo_commerce52.erb'),
  }
}
