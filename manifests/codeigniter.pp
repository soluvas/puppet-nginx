# Define: nginx::codeigniter
#
# Create a codeigniter fcgi site config from template using parameters.
...
#
# Source: http://docs.codeigniter.org/dev/Install_Moodle_On_Ubuntu_with_Nginx/PHP-fpm
#
# Templates :
# * nginx/codeigniter.erb
#
# Sample Usage :
...
#				      "codeigniter.${::fqdn}",
#				      ]
#  nginx::codeigniter { "codeigniter.${::fqdn}":
#    root          => "/home/${developer}/git/codeigniter",
#    server_name   => ["codeigniter.${::fqdn}"],
...
define nginx::codeigniter(
  ...
  nginx::site { $name:
    ...
    content => template('nginx/codeigniter.erb'),
  }
}
