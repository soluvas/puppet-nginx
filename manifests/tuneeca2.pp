# Define: nginx::tuneeca2_site
#
# Create a tuneeca2 fcgi site config from template using parameters.
...
#
# Templates :
# * nginx/tuneeca2_site.erb
#
define nginx::tuneeca2(
  $root,
  $fastcgi_pass,
  $domain,
  $ensure              = 'present',
  ...
  nginx::site { $name:
    ...
    content => template('nginx/tuneeca2.erb'),
  }
}
